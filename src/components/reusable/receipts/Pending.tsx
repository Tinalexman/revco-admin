...
export interface iPendingReceiptData {
  invoiceNo: string;
  payer: string;
  payerEmail: string;
  payerPhone: string;
...
const Pending: FC<{ receipt: iPendingReceiptData }> = ({ receipt }) => {
  const colors: iStateColors = stateColorsData[capitalize(receipt.state)];
  ...
  const downloadReceipt = () => {
    ...
    const pinContainer = document.getElementById("pin-header") as HTMLElement;
    ...
    if (receiptElement) {
      html2canvas(receiptElement, {
        ...
        pdf.save(`Invoice Receipt ${receipt.invoiceNo}.pdf`);
        ...
        <div className="w-full h-full bg-[url('.././assets/Background.png')] bg-center bg-cover bg-no-repeat relative">
          ...
          <div className="mt-[11.38px] flex gap-4 w-full">
            ...
            <div className={`flex items-center gap-2 w-[320px] h-[79.72px]`}>
              <Image
                src={`/${receipt.state}.svg`}
                alt="logo"
                className="size-[79.72px] object-contain"
                width={72}
                height={72}
              />
              <div
          ...
          <div className="mt-[12.28px] flex flex-col px-[41px] w-full relative">
            <Image
              src={Coat}
              alt="coat of arms"
            ...
            <div className="flex flex-col w-full">
              <div
                className="w-full h-[35px] rounded-t-[6px] flex items-center"
                style={{
                  background: colors.sectionHeader,
                }}
              >
                <h2 className="font-semibold text-[14px] leading-[16.94px] ml-[10px]">
                  PAYER INFORMATION
                </h2>
              </div>
              <div className="w-full h-[29px] justify-between flex">
                <div
                  className="w-[253px] h-full flex items-center"
                  style={{
                    background: colors.sectionItemKey,
                  }}
                >
                  <h2 className="font-medium text-[12px] leading-[14.52px] ml-[10px]">
                    PAYER&apos;S NAME
                  </h2>
                </div>
                <div
                  className="w-[549px] h-full flex items-center justify-end"
                  style={{
                    background: colors.sectionItemValue,
                  }}
                >
                  <h2 className="font-medium text-[12px] leading-[14.52px] mr-[10px]">
                    {receipt.payer}
                  </h2>
                </div>
              </div>
            ...
            <div className="flex flex-col w-full mt-[13px]">
              ...
              <div className="w-full flex gap-[2px] h-[44px] text-[11px] leading-[13.31px] font-medium">
                <div
                  className="w-[82px] h-full px-[10px] py-[7px]"
                  style={{
                ...
                <div
                  className="w-[100px] h-full px-[10px] py-[7px]"
                  style={{
                    background: colors.otherSectionItemKey,
                  }}
                >
                ...
                <div
                  className="w-[260px] h-full px-[10px] py-[7px]"
                  style={{
                    background: colors.otherSectionItemKey,
                  }}
                >
                ...
                <div
                  className="w-[150px] h-full px-[10px] py-[7px]"
                  style={{
                    background: colors.otherSectionItemKey,
                  }}
                >
              ...
              <div className="w-full h-full flex gap-[2px] text-[12px] leading-[14.52px] mt-[2px] font-medium">
                <div
                  className="w-[82px] px-[10px] py-[7px]"
                  style={{
                    background: colors.otherSectionItemValue,
                  }}
                ></div>
                <div
                  className="w-[101px] px-[2px] py-[7px]"
                  style={{
                    background: colors.otherSectionItemValue,
                  }}
                ></div>
                <div
                  className="w-[260px] px-[10px] py-[7px]"
                  style={{
                    background: colors.otherSectionItemValue,
                  }}
                >
                ...
                <div
                  className="w-[150px] px-[10px] py-[7px]"
                  style={{
                    background: colors.otherSectionItemValue,
                  }}
                >
              ...
              <div className="w-full flex gap-[2px] h-[29px] mt-[2px] font-bold text-[12px] leading-[14.52px]">
                <div
                  className="w-[451px] h-full flex justify-end items-center"
                  style={{
                    background: colors.otherSectionItemValue,
                  }}
                >
            ...
            <div className="flex flex-col w-full mt-[13px]">
              ...
              <div className="w-full h-[29px] gap-[1px] flex">
                ...
                <div
                  className="w-[550px] h-full flex items-center justify-end"
                  style={{
                    background: colors.sectionItemValue,
                  }}
                >
              ...
              <div className="w-full min-h-[29px] gap-[1px] flex mt-[3px]">
                <div
                  className="w-[253px] flex items-center"
                  style={{
                    background: colors.sectionItemKey,
                  }}
                >
                ...
                <div
                  className="w-[550px] flex items-center justify-end"
                  style={{
                    background: colors.sectionItemValue,
                  }}
                >
            ...
            <div className="mt-[29px] w-[255px] flex flex-col">
              <div
                id="pin-header"
                className="w-full rounded-t-[8px] h-[25px] flex items-center"
                style={{
                  background: colors.pinHeader,
                }}
              >
                <h2 className="text-[13.3px] leading-[16.1px] ml-[12px] font-bold">
                  PIN
                </h2>
              </div>
              <div
                className="w-full mt-[3px] h-[45px] flex items-center rounded-b overflow-hidden"
                style={{
                  background: colors.pinValue,
                }}
              >
                <h2 className="text-[20px] leading-[24.2px] ml-[12px] font-normal">
                  {receipt.invoiceNo}
                </h2>
              </div>
